...
function BusinessCardFace() {
  ...
  return (
    <div className="card-print relative flex h-[55mm] w-[85mm] flex-col justify-between overflow-hidden rounded-xl border border-white/10 bg-indigo-950 p-4 text-slate-100 shadow-soft print:rounded-none print:border-slate-300 print:shadow-none">
      ...
      <div className="relative flex items-end justify-between gap-3">
        ...
        <div className="flex shrink-0 flex-col items-center gap-1">
          ...
          />
          <span className="text-center text-[8px] uppercase tracking-[0.1em] text-slate-400">
            WhatsApp
          </span>
        </div>
      </div>
